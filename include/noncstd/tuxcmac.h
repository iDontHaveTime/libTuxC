...
#define TUXC_GP_REG_ARRAY {TUXC_ARG_ONE_REG, TUXC_ARG_TWO_REG, TUXC_ARG_THREE_REG, TUXC_ARG_FOUR_REG, TUXC_ARG_FIVE_REG, TUXC_ARG_SIX_REG}
#define TUXC_FP_REG_ARRAY {TUXC_FARG_ONE_REG, TUXC_FARG_TWO_REG, TUXC_FARG_THREE_REG, TUXC_FARG_FOUR_REG, TUXC_FARG_FIVE_REG, TUXC_FARG_SIX_REG, TUXC_FARG_SEVEN_REG, TUXC_FARG_EIGHT_REG}
